...
<li class="subscribe"><span class="span-subscribe">downloads</span> ${f}</li>
    ...
    `).join("")}function d(i){const t="https://pixabay.com/api/",o="43311498-bd26fa1e6ae7e25f586fd794c",r=new URLSearchParams({key:o,q:i,image_type:"photo",orientation:"horizontal",safesearch:"true"}),e=`${t}?${r}`;return fetch(e).then(s=>{if(!s.ok)throw new Error(s.status);return s.json()})}const h=new m(".gallery a",{captionsData:"alt",captionPosition:"bottom",captionDelay:250}),l=document.querySelector(".js-list"),n=document.querySelector(".js-search-form"),u=document.querySelector(".hide");n.addEventListener("submit",y);function y(i){i.preventDefault(),u.classList.remove("hide"),l.innerHTML="";const t=n.elements.picture.value;n.reset(),d(t).then(r=>{r.hits.length===0?(o(),c.error({title:"Error",message:"Sorry, there are no images matching your search query. Please try again!"})):(l.insertAdjacentHTML("beforeend",p(r.hits)),h.refresh())}).catch(r=>{console.log("error",r),o(),c.error({title:"Error",message:"Sorry, there are no images matching your search query. Please try again!"})});function o(){u.classList.add("hide")}}
